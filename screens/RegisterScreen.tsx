  ...
  return (
    ...
    >
      <View style={{ flex: 1, paddingHorizontal: spacing.lg, justifyContent: 'center' }}>
        <Text style={{ color: colors.text, fontSize: 24, fontWeight: '800', marginBottom: spacing.sm }}>
          Criar conta
        </Text>
        ...
        <MainButton label={loading ? 'Criando...' : 'Criar conta'} onPress={onSubmit} />
        {loading ? (
        ...
        <View style={{ flexDirection: 'row', marginTop: spacing.lg }}>
          <Text style={{ color: colors.muted, fontSize: typography.body }}>Já possui conta? </Text>
